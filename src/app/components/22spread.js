...
export function twentytwospread() {
  return (
    <div className={styles.components}>
        <hr className={styles.line}></hr>
        <p></p>
        <h3 className={styles.components}>22 Spread</h3>
        <video width="320" height="240" controls preload="none">
          <source src="./videos/twentytwoSpread.mp4" type="video/mp4" playsInline />
        ...
        <img width="320" src="./twentytwoSpreadPhaseOne.jpg"></img>
...
export default twentytwospread;